...
<div class="modal" id="open_knowledge_modal">
	<div class="modal_content card card-body d-flex" id="open_knowledge_modal_content" title="클릭하면 창이 닫힙니다.">
		...
		<div class="flex-glow-1 mb-3" style="overflow-y: auto;">
			<p class="card-text"><b>1. 인강인강은 성장기회의 평등을 추구합니다.</b><br>
				우리는 때로 무언가를 배워야만 합니다.<br>
				하지만 여러 이유로 당연하다고 생각되어 지는것들이 누군가에게는 사치가 되기도 합니다.<br>
				인강인강은 누구나, 경제적으로 시간적 제약없이 내가 원하는 것을 배우고, 지식을 나눌 수 있는 공간입니다.
			</p>
			<p class="card-text"><b>2. 전문 지식으로 수익이 가능한 유일한 곳.</b><br>
				인강인강은 기술 강의, 멘토링으로 의미 있는 보상을 가질 수 있는 유일한 플랫폼 입니다. <br>
				97만명의 수강생이 강의를 신청할 때마다 수익을 얻을 수 있어요!<br>
				지속가능한 수익과 명예를 가져가세요 :)
			</p>
			<p class="card-text"><b>3. 인강인강은 70% ~ 100% 의 비율의 높은 수익을 제공합니다.</b><br>
				좋은 지식은 합당한 보상에서 나온다고 인강인강은 생각합니다. <br>
				때문에 인강인강은 다른 학습 서비스에 비해 월등히 높은 수익을 드리고 있어요.<br>
				실제로 인강인강엔 꾸준히 월 수백 ~ 수천 만원 이상의 수익을 가져가는 많은 지식공유자들이 계셔요. 
			</p>
			<p class="card-text"><b>4. 인강인강의 강의는 지식공유자가 자유롭게 운영할 수 있습니다.</b><br>
